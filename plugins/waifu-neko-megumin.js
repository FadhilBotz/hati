...
case 'waifu':
  ...
  conn.sendButton(m.chat, 'Istrinya bang Fuad🐧', author, json.url, [['waifu', `${usedPrefix}waifu`]], m)
break
...
case 'neko':
  ...
  conn.sendButton(m.chat,  'Furry Indonesia solid solid', wm, neko.url, [['Next','.neko']],m)
break 
...
case 'megumin':
  ...
  conn.sendButton(m.chat, 'Istrinya bang Fuad🐦', wm, megumin.url, [['Next','.megumin']],m)
break
